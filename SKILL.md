...
## Skill Name
`sshgit` (evolved to daemon-based peer execution)

## Description
This skill enables execution of commands on remote peers via the daemon's peer networking infrastructure. It replaces SSH-based command execution with daemon-native peer-to-peer communication over WireGuard VPN.
