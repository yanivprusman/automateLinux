...
static int pathMatches(const char *pattern, const char *path, int isDirectory,
                       int checkDir) {
...
void print_size(long long size) {
  if (size < 1024) {
    ...
    printf("%.2fK", (double)size / 1024);
  } else if (size < 1024 * 1024 * 1024) {
    printf("%.2fM", (double)size / (1024 * 1024));
  } else {
    printf("%.2fG", (double)size / (1024 * 1024 * 1024));
  }
}
